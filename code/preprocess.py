...
def Registration(moving_file, label_file, fixed_file, output_file):
  for fixed_filename in sorted(os.listdir(fixed_file)):
    for moving_filename in sorted(os.listdir(moving_file)):
      ...
      # save moved image
      vxm.py.utils.save_volfile(moved_pred.squeeze(), output_file+'image/'+ fixed_filename[:3]+'_'+ moving_filename[:2]+ fixed_filename[3:], fixed_affine)
      # save moved label
      vxm.py.utils.save_volfile(warped_seg.squeeze(), output_file+'label/'+ fixed_filename[:3]+'_'+ moving_filename[:2]+ fixed_filename[3:], fixed_affine)
...
Registration(moving_file='/cis/home/tliu77/Documents/training/skull_stripping/', label_file='/cis/home/tliu77/Documents/training/delineated/manual/',
             fixed_file='/cis/home/tliu77/Documents/training/skull_stripping_un/', output_file='/cis/home/tliu77/Documents/training/registration/')
